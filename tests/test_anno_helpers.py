...
- building annotated tables (success and failure cases)
"""
...
class TestValidate:
    ...
    def test_validate_raises_missingfileerror_when_input_missing(
        ...
        """_validate raises MissingFileError if input_data.csv is missing."""
...
class TestAnnotate:
    ...
    def test_annotate_raises_missingfileerror_when_input_missing(
        self, tmp_path
    ):
